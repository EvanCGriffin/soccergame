...
public:
  ...
  inline void  Rotate(const b2Vec2 &fwd, const b2Vec2 &side);

   //applys a transformation matrix to a std::vector of points
  inline void Transformb2Vec2s(std::vector<b2Vec2> &vPoints);

  //applys a transformation matrix to a point
  inline void Transformb2Vec2s(b2Vec2 &vPoint);
...
//applies a 2D transformation matrix to a std::vector of b2Vec2s
inline void C2DMatrix::Transformb2Vec2s(std::vector<b2Vec2> &vPoint)
{
...
//applies a 2D transformation matrix to a single b2Vec2
inline void C2DMatrix::Transformb2Vec2s(b2Vec2 &vPoint)
{
...
inline void C2DMatrix::Rotate(const b2Vec2 &fwd, const b2Vec2 &side)
{
  C2DMatrix::Matrix mat;
